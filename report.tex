...
\begin{figure}[h]
     ...
     \begin{minipage}[b]{.5\linewidth}
       ...
       {\includegraphics[width=.45\linewidth]{reconstructions/dtw-simple-50}}%
       \hfill
       \subcaptionbox{DTW 10 planes}
       {\includegraphics[width=.45\linewidth]{reconstructions/dtw-simple-10}}
       \hfill
       \subcaptionbox{CSPA 50 planes}
       {\includegraphics[width=.45\linewidth]{reconstructions/cspa50-simple-50}}%
       \hfill
       \subcaptionbox{CSPA 10 planes}
       {\includegraphics[width=.45\linewidth]{reconstructions/cspa50-simple-10}}
     \end{minipage}%
