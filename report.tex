...
\begin{figure}[h]
     \begin{subfigure}[b]{0.3\textwidth}
         ...
         \includegraphics[width=\textwidth]{originals/simple}
         \caption{Original}
         \label{fig:simple_original}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{reconstructions/dtw-simple-50}
         \caption{DTW 50 planes}
         \label{fig:simple_dtw_50}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{reconstructions/dtw-simple-10}
         \caption{DTW 10 planes}
         \label{fig:simple_dtw_10}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{originals/simple}
         \caption{Original}
         \label{fig:simple_original2}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{reconstructions/cspa50-simple-50}
         \caption{CSPA 50 planes}
         \label{fig:simple_cspa50_50}
     \end{subfigure}
     \hfill
     \begin{subfigure}[b]{0.3\textwidth}
         \centering
         \includegraphics[width=\textwidth]{reconstructions/cspa50-simple-10}
         \caption{CSPA 10 planes}
         \label{fig:simple_cspa50_10}
     \end{subfigure}
