...
Scans have multiple planes separated by some distance. For the same spatial resolution, smaller objects will have fewer planes scanning through them. Lower plane counts are also better for lowering scan time. Reconstruction methods which can handle lower plane counts per object should be better for smaller objects and lowering scan time.
