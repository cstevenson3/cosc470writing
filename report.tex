...
In the branching cases, CSPA splits contours into separate point correspondences, and each correspondence has linear complexity. Mackay's implementation with merging creates larger contours for DTW to act on. Filling in the cost matrix gives DTW quadratic complexity. The slowdown for DTW relative to CSPA, especially at low plane count where the proportion of branching cases is higher, can probably be attributed to this.
